                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="<?= base_url('admin/form_barang') ?>"><i class="fa fa-circle-o"></i> Tambah Data Barang</a></li>
                                    ...
                                    <form action="<?= base_url('admin/proses_barang_insert') ?>" role="form" method="post">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group" style="display:inline-block;">
                                                ...
                                                <input type="text" name="kd_barang" style="width:90%;margin-right: 67px;" class="form-control" id="kd_barang" placeholder="Kode Barang">
                                            </div>
                                            <div class="form-group" style="display:inline-block;">
                                            ...
                                            <div class="form-group" style="display:inline-block;">
                                                <button type="reset" class="btn btn-basic" name="btn_reset" style="width:95px;margin-right:1px"><i class="fa fa-eraser" aria-hidden="true"></i> Reset</button>
                                            </div>
                                            ...
                                            <div class="box-footer" style="width:93%;">
                                                ...
                                                <a type="button" class="btn btn-info" style="width:13%;margin-right:29%" href="<?= base_url('admin/tabel_barang') ?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat Barang</a>
