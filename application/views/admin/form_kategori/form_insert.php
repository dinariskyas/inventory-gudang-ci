                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="<?= base_url('admin/form_kategori') ?>"><i class="fa fa-circle-o"></i> Tambah Data Kategori</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="container">
                            ...
                            <div class="box box-primary" style="width:94%;">
                                ...
                                <!-- form start -->
                                <div class="container">
                                    <form action="<?= base_url('admin/proses_kategori_insert') ?>" role="form" method="post">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group" style="display:inline-block;">
                                                ...
                                                <input type="text" name="nama_kategori" style="width:90%;margin-right: 67px;" class="form-control" id="nama_kategori" placeholder="Nama Kategori">
                                            </div>
                                            <div class="form-group" style="display:inline-block;">
                                            ...
                                            <div class="box-footer" style="width:93%;">
                                                ...
                                                <a type="button" class="btn btn-info" style="width:13%;margin-right:29%" href="<?= base_url('admin/tabel_kategori') ?>" name="btn_listkategori"><i class="fa fa-table" aria-hidden="true"></i> Lihat Kategori</a>
